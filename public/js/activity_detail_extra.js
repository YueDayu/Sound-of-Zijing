...
var get_ticket_method_content=
    ...
    '· 在微信中直接回复<i style="color:#d0dd1e">"抢票　'+activity_key+' 抢票张数"</i>（此活动抢票张数不超过 <i style="color:#d0dd1e">'+activity_max_tickets+'</i> 张，若不填写抢票张数，默认抢 1 张）<br>'+
    '· 或者，点击"抢票"菜单下的<i style="color:#d0dd1e">"'+activity_key+'"</i>按钮（此方法只能抢 1 张）<br>';
