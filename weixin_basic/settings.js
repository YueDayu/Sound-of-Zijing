...
var weichat_config = require("../config.json").weichat_config;

exports.WEIXIN_TOKEN = weichat_config.TOKEN;
exports.WEIXIN_APPID = weichat_config.APPID;
exports.WEIXIN_SECRET = weichat_config.SECRET;
...
var WEIXIN_EVENT_KEYS = {
  ...
  'ticket_default_number': 'TICKET_NUMBER'
};
    ...
    },
    {
      ...
      "sub_button": [
        ...
        },
        {
          "type": "click",
          "name": "默认张数",
          "key": WEIXIN_EVENT_KEYS['ticket_default_number'],
          "sub_button": []
        },
        {
          "type": "view",
